...
})({"iSE7q":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "63f2492da6c88831";
"use strict";
...
},{}],"kBdH4":[function(require,module,exports) {
//exceptions
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "store", ()=>store);
var _actionIsNotAnObjectExceptionJs = require("./exception/action-is-not-an-object.exception.js");
var _actionHasNoTypeExceptionJs = require("./exception/action-has-no-type.exception.js");
// import { ActionHasNoTarget } from "./exeption/action-has-no-target.exception.js";
...
function createStore(reducer, initialState) {
    ...
    function dispatch(action) {
        if (!isObject(action)) throw new (0, _actionIsNotAnObjectExceptionJs.ActionIsNotAnObject)(action);
        if (!("type" in action)) throw new (0, _actionHasNoTypeExceptionJs.ActionHasNoType)();
        const isInitType = action.type === "@INIT";
        if (!isInitType && !("target" in action)) throw new ActionHasNoTarget();
    ...
    function follow(followFn) {
        ...
        return function unfollow() {
            ...
            if (nodeIndex >= 0) followers.splice(nodeIndex, 1);
        };
    }
    dispatch({
        type: "@INIT"
...
},{"./exception/action-is-not-an-object.exception.js":"eTgte","./exception/action-has-no-type.exception.js":"kRXB6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iSE7q"], null, "parcelRequire2d1f")

//# sourceMappingURL=index.a6c88831.js.map
